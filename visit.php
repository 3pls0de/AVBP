...
echo " $merah PERHATIAN! TOOL INI MASIH WORK JIKA TIDAK WORK HUBUNGI MEDSOS DI BAWAH SUBSCRIBE  JUGA GUYS YOUTUBENYA BIAR UPDATE TOOL BARU LAGI ";


echo " \n";

echo "$hijau INFO SCRIPT : \n";

echo " Author: rianto(mr.lilung) \n";

echo " Facebook https://www.facebook.com/rianto.rianto.16547008 \n";

echo " Youtube : lilung project \n";

echo " Email : lilungproject@gmail.com \n";

echo " \n \n";

echo " ~~~~~~ AUTO VISITOR BLOG 2019 BY MR.LILUNG(RIANTO) ~~~~~\n ";

echo ' Url Website : ';

$url = trim(fgets(STDIN));

echo ' Jumlah visitor bot: ';
...
for($i = 1; $i < $max+1; $i++) {
	...
	echo $i.". VISITOR TERKIRIM - [".$class->jalankan()."\n";
